...
namespace FisherTournament.Infrastracture.Persistence.Migrations.Tournament
{
    ...
    [Migration("20230807223925_StandaloneFisher")]
    partial class StandaloneFisher
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FisherTournament.Domain.UserAggregate.User", b =>
                {
                    b.HasOne("FisherTournament.Domain.FisherAggregate.Fisher", null)
                        .WithOne()
                        .HasForeignKey("FisherTournament.Domain.UserAggregate.User", "FisherId")
                        .OnDelete(DeleteBehavior.NoAction);
                });
